  ...
  <main class="room">
    <section class="panel section">
      ...
      <div class="button-row">
        ...
        <button v-if="isModerator && state.revealed && state.current_work_item_index > 0" class="btn ghost" @click="navigateWorkItem('previous')">Previous Item</button>
        <button v-if="isModerator && state.revealed && state.current_work_item_index < state.work_items.length - 1" class="btn primary" @click="navigateWorkItem('next')">Next Item</button>
      </div>
    </section>
